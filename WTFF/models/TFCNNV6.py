...
class TFCNN(nn.Module):
    def __init__(
        ...
        # TFCNN V6
        # self.layer1 = self._make_layer(64, kernel_size=5)
        # self.layer2 = self._make_layer(64, kernel_size=5)
        # self.layer3 = self._make_layer(64, kernel_size=13)
        # self.layer4 = self._make_layer(64, kernel_size=29)
        # self.layer5 = self._make_layer(64, kernel_size=61)
        # self.layer6 = self._make_layer(64, kernel_size=125)
        ...
        # self.layer6 = self._make_layer(64, kernel_size=3)

        # TFCNN V6 C1
        # self.layer1 = self._make_layer(64, kernel_size=1)
        # self.layer2 = self._make_layer(64, kernel_size=1)
        # self.layer3 = self._make_layer(64, kernel_size=5)
        # self.layer4 = self._make_layer(64, kernel_size=13)
        # self.layer5 = self._make_layer(64, kernel_size=29)
        # self.layer6 = self._make_layer(64, kernel_size=61)
        ...
        self.layer6 = self._make_layer(64, kernel_size=251)
